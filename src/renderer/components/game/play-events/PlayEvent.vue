...
import NeutralFigureReturnedEvent from '@/components/game/play-events/NeutralFigureReturnedEvent'
...
const MAPPING = {
  ...
  'neutralfigure-returned': NeutralFigureReturnedEvent
}
